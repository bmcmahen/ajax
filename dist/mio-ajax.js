!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var o;"undefined"!=typeof window?o=window:"undefined"!=typeof global?o=global:"undefined"!=typeof self&&(o=self),(o.mio||(o.mio={})).ajax=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
var request = require('superagent');
var qs = require('qs');

var createPlugin = module.exports = function(baseUrl, urlOverrides) {
...
var store = createPlugin.store = Object.create(null);
...
store.findOne = function(extras, cb) {
  var Model = this;
  var opts = Model.options;
...
store.save = function(model, changed, cb) {
  var Model = this;

  if (model.primary) {
    return store.update.call(Model, model, changed, cb);
  }

  var opts = Model.options;

  var url = urlForAction.call(model, 'create', opts);
...
store.update = function(model, changed, cb) {
  var Model = this;
  var opts = Model.options;

  var url = urlForAction.call(model, 'update', opts);
...
store.remove = function(model, cb) {
  var Model = this;
  var opts = Model.options;

  var url = urlForAction.call(model, 'destroy', opts);
...
},{"qs":5,"superagent":10}],2:[function(require,module,exports){
/*!
