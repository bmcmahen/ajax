(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['require'], factory); /* AMD */
  } else if (typeof exports === 'object') {
    module.exports = factory(require); /* CommonJS */
  } else {
    root.mio = (root.mio || {});
    root.mio.ajax = factory(root.require); /* Global */
  }
  ...
  var plugin = function(baseUrl, urlOverrides) {
  ...
  var store = plugin.store = Object.create(null);
